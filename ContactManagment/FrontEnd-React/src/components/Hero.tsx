...
"
        >
          <h1 className="h1 mb-6">
            Manage Your All Unorganized Contacts with&nbsp;
          ...
          <p className="body-1 max-w-3xl mx-auto mb-6 text-n-2 lg:mb-8">
            This application is created with React using TypeScript. React
            communicates with Springboot to manipulate and fetch data which is
            stored in MySQL which is running in a Dockerized container.
          </p>
